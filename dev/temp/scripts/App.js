...
var _GetInTouch = __webpack_require__(3);

var _GetInTouch2 = _interopRequireDefault(_GetInTouch);
...
var _PortfolioFilter = __webpack_require__(9);

var _PortfolioFilter2 = _interopRequireDefault(_PortfolioFilter);

var _PortfolioGallery = __webpack_require__(10);
...
//mobile menu script
var mm = new _GetInTouch2.default();

//get in touch 

var git = new _Menu2.default();

// reveal elemnts on scroll using waypoints

var skills = new _RevealOnScroll2.default(".skills__inner", "80%", true);
var services = new _RevealOnScroll2.default(".service-item", "80%");
var portfolio = new _RevealOnScroll2.default(".browser", "80%");
var testimonials = new _RevealOnScroll2.default(".testimonial", "80%");
...
var getInTouch = function () {
	function getInTouch() {
		...
		this.getInTouchButton = (0, _jquery2.default)('.btn--getInTouch');
		this.getInTouchContainer = (0, _jquery2.default)('.get-in-touch');
		this.mainContent = (0, _jquery2.default)('.container');
		this.hideButton = (0, _jquery2.default)('#hideMe');
		this.triggerHide = (0, _jquery2.default)('.hero');
		this.events();
		this.createWayPoint();
	}
...
var MenuOnMobileView = function () {
	function MenuOnMobileView() {
		_classCallCheck(this, MenuOnMobileView);

		this.header = (0, _jquery2.default)('.header');
		this.menuIcon = (0, _jquery2.default)('.header__sandwich-icon');
		this.nav = (0, _jquery2.default)('.nav');
		this.events();
	}

	_createClass(MenuOnMobileView, [{
		key: 'events',
		value: function events() {
	...
	return MenuOnMobileView;
}();

exports.default = MenuOnMobileView;
...
var RevealOnScroll = function () {
	function RevealOnScroll(selector, offset, isSkill) {
			...
			this.itemsToReveal.each(function () {
				...
				new Waypoint({
					...
					handler: function handler() {
						if (!_this.isSkill) {
							(0, _jquery2.default)(_self).addClass('reveal-item--is-visible');
						} else {

							if (!(0, _jquery2.default)(_self).hasClass('revealed')) {
								var percentage = (0, _jquery2.default)(_self).data("percentage");
								var percentageDiv = "<div class='skills__percentage'>" + percentage + "</div>";
								(0, _jquery2.default)(percentageDiv).insertAfter(_self);
								(0, _jquery2.default)(_self).css({ 'width': percentage });

								(0, _jquery2.default)(_self).addClass('revealed');
							}
						}
					},
...
var FixedHeader = function () {
	function FixedHeader() {
		...
		this.headerLinks = (0, _jquery2.default)(".scrolling-nav");
...
var PortfolioFilter = function () {
	function PortfolioFilter() {
		_classCallCheck(this, PortfolioFilter);

		this.btnFilter = (0, _jquery2.default)(".btn--filter");
		this.foliotoFilter = (0, _jquery2.default)('.filter');
		this.events();
	}

	_createClass(PortfolioFilter, [{
		key: "events",
		value: function events() {
			this.btnFilter.click(function (_this) {
				return function () {

					var type = (0, _jquery2.default)(this).attr('data-filter');
					if (type == "all") {
...
exports.default = PortfolioFilter;
